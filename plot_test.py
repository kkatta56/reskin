...
d, col_names = openFile('datasets/samples/port_2_depth_1.csv')
norm_df = pd.DataFrame(d, columns=col_names)
d, col_names = openFile('datasets/samples/port_3_depth_1.csv')
norm_df2 = pd.DataFrame(d, columns=col_names)


# Plot data
norm_df.plot(y="T0", kind="line")
norm_df2.plot(y="T0", kind="line")
