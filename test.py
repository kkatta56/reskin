...
db.move([0, 0, 0])
res_bl.append(rs.get_data(2))
fs_bl.append(fs.get_data(2))
res_bl.append(rs.get_data(2))
fs_bl.append(fs.get_data(2))
#db.move([8, 0, 0])
#db.move([8, 0,-8])
#res_contact.append(rs.get_data(1))
#fs_contact.append(fs.get_data(1))
#db.move([8, 0, 0])
#db.move([8, 16, 0])
#db.move([8, 16, -8])
#db.move([8, 16, 0])
...
new_row = []
print("======")
print(res_bl[0][0][2:22])
print(res_bl[0])
new_row.append(res_bl[0][0][2:22])
print("======")
print(fs_bl[0][0][0])
new_row.append(fs_bl[0][0][0])
print("======")
print(new_row)